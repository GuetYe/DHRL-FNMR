...
class Config:
    ...
    PKL_STEP = 3
    PKL_NUM = 12
    PKL_START = 0  # index 从0开始
    PKL_CUT_NUM = PKL_START + PKL_NUM * PKL_STEP
    # PKL_START + PKL_NUM * PKL_STEP  # 结束index
    ...
    if sys_platform == "Windows":
        ...
        xml_topology_path = Path(r'/home/zcw/topologies/topology2.xml')
        pkl_weight_path = Path(r"/home/zcw/HDRL-FNMR/dataset")

        # xml_topology_path = Path(r'/home/zcw/topologies/topology_node_10.xml')
        # pkl_weight_path = Path(r"/home/zcw/DRL-M4MR/dataset/node10_data")

        # xml_topology_path = Path(r'/home/zcw/topologies/topology_node_21.xml')
        # pkl_weight_path = Path(r"/home/zcw/DRL-M4MR/dataset/node21_data")
