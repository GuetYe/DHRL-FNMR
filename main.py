...
if __name__ == '__main__':
    ...
    parser.add_argument('--modify_controller', '-c', default='meta', choices=['intrinsic', 'meta'])
    parser.add_argument('--manualname', default="pkl12")
    parser.add_argument('--manualparam', default="")
